...
#define TRIG 3 //2번 핀을 Trig로 설정
#define ECHO 2 //3번 핀을 Echo로 설정
#define DHT_OUT 7 //4번 핀을 온습도센서 out으로 설정
#define DC_MOTOR 6 //5번 핀으로 DC 모터 제어 
#define SERVO 9 //6번 핀으로 서보 모터 제어 
#define TOUCH 8 //7번 핀으로 터치 이벤트 처리
#define BLUE_PIN 10 //9번 핀으로 BLUE 제어 
#define GREEN_PIN 11 //11번 핀으로 GREEN 제어
#define RED_PIN 5 //10번 핀으로 RED 제어
